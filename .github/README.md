...
2. I'll handle authentication via the user's Strava account. Once the user is logged in, user's exercise history will be queried via the [Strava API](https://developers.strava.com/). _The Strava integration is still in development._
